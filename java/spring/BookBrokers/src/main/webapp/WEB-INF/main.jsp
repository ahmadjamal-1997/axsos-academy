...
<div class="row">
	<div class="col">
		<h2>Registration</h2>
		<form:form action="/new/user" method="post"  modelAttribute="newUser">
	<div class="row">
	<div class="col-auto">
  <div class="row">
  ...
  <div class="row">
    <form:label path="confirm" type="password" class="col-form-label">Confirm Password </form:label>
  </div>
  <form:errors path="confirm"/>
  <div class="row">
    <form:input path="confirm"  type="password" class="form-control" aria-describedby="confirmPWHelpInline"/>
  </div>
  </div>
  </div>
