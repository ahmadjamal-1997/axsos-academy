...
<div class="row">
    <div class="col">
        <form:form action="/edit/${thisBook.id}" method="post"  modelAttribute="book">
  ...
  <div class="row">
    <form:label  path="mythoughts"  class="col-form-label">thoughts </form:label>
  </div>
  <form:errors path="mythoughts"/>
  <div class="row">
    <form:input path="mythoughts"  class="form-control" aria-describedby="passwordHelpInline"/>
  </div>
